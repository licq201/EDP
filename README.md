...
**参考**：Glickman, M.E. (2013). *Example of the Glicko-2 System*. Boston University.
...
| 先验融合 | 对数池 / 线性池 | 组合后验 |
| Glicko-2 评级 | Glickman (2013) | μ, RD, σ |
...
| Glicko-2 评级 | Glickman, M.E. (2013). *Example of the Glicko-2 System*. Boston University. |
